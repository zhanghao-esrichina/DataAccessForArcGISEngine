...
namespace LSGISHelper
{
    public class WorkspaceHelper
    {
        ...
        {
            string sServer = pWS.ConnectionProperties.GetProperty("Server").ToString();
            string sIns = pWS.ConnectionProperties.GetProperty("Instance").ToString();
            string sUser = pWS.ConnectionProperties.GetProperty("User").ToString();
        
            return GetSDEWorkspace(sServer,sIns,sUser,sPws, sVersion);
